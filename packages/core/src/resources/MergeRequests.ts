...
import type { CommitSchema, CommitDiffSchema } from './Commits';
import type { IssueSchema, TimeStatsSchema } from './Issues';
import type { PipelineSchema, ExpandedPipelineSchema } from './Pipelines';
...
export interface MergeRequestWithChangesSchema extends MergeRequestSchema {
...
export class MergeRequests<C extends boolean = false> extends BaseResource<C> {
  ...
  all<E extends boolean = false, P extends 'keyset' | 'offset' = 'offset'>(
  ...
  ): Promise<GitlabAPIResponse<CondensedMergeRequestSchema[], C, E, P>> {
    let prefix = '';
    ...
    return RequestHelper.get<CondensedMergeRequestSchema[]>()(
      this,
  ...
  closesIssues<E extends boolean = false>(
    projectId: string | number,
    mergerequestIId: number,
    options?: Sudo & ShowExpanded<E>,
  ...
  commits<E extends boolean = false>(
    projectId: string | number,
    mergerequestIId: number,
    options?: Sudo & ShowExpanded<E>,
  ...
  diffVersions<E extends boolean = false>(
    projectId: string | number,
    mergerequestIId: number,
    options?: Sudo & ShowExpanded<E>,
  ...
  mergeToDefault<E extends boolean = false>(
    ...
    return RequestHelper.get<{ commit_id: string }>()(
      this,
  ...
  pipelines<E extends boolean = false>(
    projectId: string | number,
    mergerequestIId: number,
    options?: Sudo & ShowExpanded<E>,
  ): Promise<
